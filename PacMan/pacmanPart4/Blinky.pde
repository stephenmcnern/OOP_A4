public class Blinky extends Ghost {
    ...
    public String toString() {
        return "[Blinky:location=[Location:(" + x + "," + y + ")], direction=" + direction + ", speed=" + speed
                + ", moving="
    ...
    public void display() // CAREFUL IF YOU MODIFY THIS CODE!!
    {
        ...
        switch (this.bearing) {
            case Game.RIGHT:
                ...
                ellipse(Game.PACMAN_SIZE - Game.PACMAN_SIZE / 2 / 2 + (Game.PACMAN_SIZE / 10), Game.PACMAN_SIZE / 2, 10,
                        10);
                break;
            case Game.LEFT:
                ellipse(Game.PACMAN_SIZE / 2 / 2 / 2, Game.PACMAN_SIZE / 2, 10, 10);
                ellipse(Game.PACMAN_SIZE - Game.PACMAN_SIZE / 2 / 2 - (Game.PACMAN_SIZE / 8), Game.PACMAN_SIZE / 2, 10,
                        10);
                break;
            case Game.DOWN:
                ellipse(Game.PACMAN_SIZE / 2 / 2, Game.PACMAN_SIZE / 2 + (Game.PACMAN_SIZE / 5), 10, 10);
                ellipse(Game.PACMAN_SIZE - Game.PACMAN_SIZE / 2 / 2, Game.PACMAN_SIZE / 2 + (Game.PACMAN_SIZE / 5), 10,
                        10);
                break;
            case Game.UP:
